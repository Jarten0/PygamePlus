from main import ObjectList, Component
...
ObjectList.new(name_='Character Object', class_=Character, addToList_=False,
	#No Dependencies
	#No Arguments

)
ObjectList.new(name_='Renderer Object', class_=Renderer, addToList_=False,
	#Dependencies
    Transform    = Transform(),
	#Arguments
    path         = '',        #<class 'str'>
...
ObjectList.new(name_='Platform Object', class_=Platform, addToList_=False,
	#Dependencies
    Transform    = Transform(),
    Collider    = Collider(Transform = Transform()),
	#No Arguments
